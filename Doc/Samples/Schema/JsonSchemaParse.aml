...
<topic id="JsonSchemaParse" revisionNumber="1">
  <developerConceptualDocument xmlns="http://ddue.schemas.microsoft.com/authoring/2003/5" xmlns:xlink="http://www.w3.org/1999/xlink">
    <introduction>
      <para>This sample parses a <codeEntityReference>T:Argon.Schema.JsonSchema</codeEntityReference>
      from JSON</para>
    </introduction>
<alert class="caution">
  <para>
    ...
    <section>
      <title>Sample</title>
      <content>
        <code lang="cs" source="..\Src\Tests\Documentation\Samples\Schema\JsonSchemaParse.cs" region="Usage" title="Usage" />
      </content>
    </section>
