...
public class JsonPatchDocument : IJsonPatchDocument
{
    ...
    public JsonPatchDocument Add(string path, object value)
    {
        ...
        Operations.Add(new("add", PathHelpers.ValidateAndNormalizePath(path), null, value));
        return this;
    }
    ...
    public JsonPatchDocument Remove(string path)
    {
        ...
        Operations.Add(new("remove", PathHelpers.ValidateAndNormalizePath(path), null, null));
        return this;
    }
    ...
    public JsonPatchDocument Replace(string path, object value)
    {
        ...
        Operations.Add(new("replace", PathHelpers.ValidateAndNormalizePath(path), null, value));
        return this;
    }
    ...
    public JsonPatchDocument Test(string path, object value)
    {
        ...
        Operations.Add(new("test", PathHelpers.ValidateAndNormalizePath(path), null, value));
        return this;
    }
    ...
    public JsonPatchDocument Move(string from, string path)
    {
        ...
        Operations.Add(new("move", PathHelpers.ValidateAndNormalizePath(path), PathHelpers.ValidateAndNormalizePath(from)));
        return this;
    }
    ...
    public JsonPatchDocument Copy(string from, string path)
    {
        ...
        Operations.Add(new("copy", PathHelpers.ValidateAndNormalizePath(path), PathHelpers.ValidateAndNormalizePath(from)));
        return this;
    }
    ...
    public void ApplyTo(object objectToApplyTo, IObjectAdapter adapter, Action<JsonPatchError> logErrorAction)
    {
        ...
        foreach (var op in Operations)
        {
            ...
            catch (JsonPatchException jsonPatchException)
            {
                ...
                errorReporter(new(objectToApplyTo, op, jsonPatchException.Message));
