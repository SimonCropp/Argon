...
<!-- endSnippet -->
  ...
  * [Debugging with Serialization Tracing](/docs/SerializationTracing.md)
  ...
  * [Serializer](/docs/Serializer)
    ...
    * [Custom ITraceWriter](/docs/Serializer/CustomTraceWriter.md)
    ...
    * [ Serialize DateFormatString](/docs/Serializer/DeserializeDateFormatString.md)
    ...
    * [DateTimeZoneHandling setting](/docs/Serializer/SerializeDateFormatString.md)
    ...
    * [TraceWriter setting](/docs/Serializer/TraceWriter.md)
  * [Xml](/docs/Xml)
